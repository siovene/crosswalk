...
package org.xwalk.app.iotivity_demo;
...
public class AppIotivityDemoActivity extends XWalkRuntimeActivityBase {
    ...
    protected void didTryLoadRuntimeView(View runtimeView) {
        if (runtimeView != null) {
            ...
            getRuntimeView().loadAppFromUrl(
                "file:///android_asset/www/iotivity_demo_index.html");
        } else {
